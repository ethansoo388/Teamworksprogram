  ...
  return (
    <div className="relative h-screen min-h-[600px] max-h-[900px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1747146114146-8b8597a53ad4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWFtJTIwd29ya3Nob3AlMjBhY3Rpdml0eXxlbnwxfHx8fDE3NjgyOTkwMjl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          alt="Team workshop activity"
