...
export function DesignThinkingCoursePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Learning Outcomes */}
      <section className="py-16 lg:py-24 px-6 lg:px-8 bg-gray-50">
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-8 bg-slate-900" id="how-we-turn-ideas">
      ...
      {/* Course Modules */}
      <section id="course-modules" className="py-16 lg:py-20 px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div
            className="mb-16"
          >
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-8 bg-slate-100">
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-8 bg-slate-800">
        <div className="max-w-4xl mx-auto">
