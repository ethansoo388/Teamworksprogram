        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10" data-reveal-group data-stagger="120">
            ...
            <div data-reveal-item className="bg-white border-2 border-slate-200 rounded-3xl p-6 sm:p-10 shadow-lg hover:border-blue-300 transition-all flex flex-col">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  <a href="/bookseat.html?from=jess-leadership&section=course-1-card" className="inline-flex items-center gap-2 px-6 py-3 text-white font-semibold rounded-lg text-sm transition-all" style={{ background: 'linear-gradient(to right,#3b82f6,#06b6d4)' }}>Book a Seat →</a>
            ...
            <div data-reveal-item className="bg-white border-2 border-slate-200 rounded-3xl p-6 sm:p-10 shadow-lg hover:border-cyan-300 transition-all flex flex-col">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  <a href="/bookseat.html?from=jess-leadership&section=course-2-card" className="inline-flex items-center gap-2 px-6 py-3 text-white font-semibold rounded-lg text-sm transition-all" style={{ background: 'linear-gradient(to right,#3b82f6,#06b6d4)' }}>Book a Seat →</a>
                  <span className="text-xs text-slate-400">2-Day Intensive</span>
                </div>
                <a href="/jess/class-schedule.html" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors">View Schedule →</a>
              </div>
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-slate-900">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8" data-reveal-group data-stagger="100">
            {[
              { course: 1, date: '7–8 Jul 2026', location: 'Indonesia, Jakarta', format: 'Face-to-face', courseName: 'High Performance Agile Leader' },
              { course: 1, date: '6–7 Aug 2026', location: 'Thailand, Bangkok', format: 'Face-to-face', courseName: 'High Performance Agile Leader' },
              { course: 2, date: '19–20 Aug 2026', location: 'Live Virtual (Zoom)', format: 'Live Virtual (Zoom)', courseName: 'Leading Hyper-Productive Teams' },
              ...
              return (
                <div key={date} data-reveal-item className="bg-slate-800 rounded-2xl p-6 transition-all" style={{ border: isC1 ? '1px solid rgba(59,130,246,0.2)' : '1px solid rgba(6,182,212,0.2)' }}>
                  ...
                  <a href="/bookseat.html?from=jess-leadership&section=upcoming-classes" className="block text-center py-3 text-white font-semibold rounded-lg text-sm transition-all" style={{ background: isC1 ? 'linear-gradient(to right,#3b82f6,#06b6d4)' : 'linear-gradient(to right,#06b6d4,#10b981)' }}>Book a Seat →</a>
                </div>
              );
            })}
          </div>
