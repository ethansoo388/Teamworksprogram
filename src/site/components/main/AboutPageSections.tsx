...
import ourJourneyMapImage from "@/assets/img/main/main-about-our-journey-map.webp";
...
export function OurBeliefSection() {
  return (
    <section className="relative py-16 lg:py-32 px-6 lg:px-16 bg-gray-900 overflow-hidden">
...
export function FounderProfileSection() {
  return (
    <section id="founder" className="py-16 lg:py-20 px-6 lg:px-16 bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
...
export function ExperienceScalesSection() {
  return (
    <section className="py-16 lg:py-20 px-6 lg:px-16 bg-[#F7F9F8] border-t-2 border-gray-300">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="bg-white border border-gray-200 shadow-sm p-8 lg:p-9">
            ...
            <form id="about-us-form" className="space-y-4" noValidate>
              ...
              {/* fullName */}
              <div>
                <label htmlFor="about-fullName" className="block text-sm font-normal text-gray-700 mb-1.5">Name<span className="text-red-500 ml-1">*</span></label>
              ...
              {/* workEmail */}
              <div>
                <label htmlFor="about-workEmail" className="block text-sm font-normal text-gray-700 mb-1.5">Work Email<span className="text-red-500 ml-1">*</span></label>
