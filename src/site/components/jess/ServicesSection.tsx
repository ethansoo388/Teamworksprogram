...
export function ServicesSection() {
  return (
    <section id="roadmap" className="py-16 sm:py-20 lg:py-28 px-6 lg:px-8 relative">
              ...
              <div className="px-2" data-carousel-slide>
                ...
                >
                  <div className="relative h-[500px] rounded-3xl overflow-hidden bg-slate-900">
                    ...
                    <div className="absolute inset-0">
                      <ImageWithFallback
                        src="/assets/img/jess/develop_agile_leaders.webp"
              ...
              <div className="px-2" data-carousel-slide>
                ...
                >
                  <div className="relative h-[500px] rounded-3xl overflow-hidden bg-slate-900">
                    ...
                    <div className="absolute inset-0">
                      <ImageWithFallback
                        src="/assets/img/jess/strengthen_teams.webp"
